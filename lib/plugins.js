...
const parentPackageJSON = require(path.join(dirs.parentRoot, 'package.json'))
...
parentPackageJSON.corePlugins.map(m => path.join(dirs.parentRoot, 'node_modules', m)).forEach(registerPlugin('core'))
